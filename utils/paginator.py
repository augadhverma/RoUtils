...
class RoboPages(discord.ui.View):
    ...
    async def interaction_check(self, interaction: discord.Interaction) -> bool:
        if interaction.user and interaction.user.id == self.original_interaction.user.id:
            return True
...
class FieldPageSource(menus.ListPageSource):
    ...
    def __init__(self, entries, *, per_page=12, **kwargs):
        ...
        self.embed = kwargs.get('embed', discord.Embed(colour=discord.Colour.blue()))
...
class TextPageSource(menus.ListPageSource):
    ...
    async def format_page(self, menu, content):
        ...
        menu.embed.description = content
        return menu.embed
...
class SimplePages(RoboPages):
    ...
    def __init__(self, entries, *, interaction: discord.Interaction, bot: Bot, per_page: int = 12, **kwargs):
        super().__init__(SimplePageSource(entries, per_page=per_page), interaction=interaction, bot=bot)
        self.embed = kwargs.get('embed', discord.Embed(colour=bot.colour))

class EmbedPages(RoboPages):
    def __init__(self, entries, *, interaction: discord.Interaction, bot: Bot, per_page: int = 12, **kwargs):
        super().__init__(FieldPageSource(entries, per_page=per_page, **kwargs), interaction=interaction, bot=bot)

class TextPages(RoboPages):
    def __init__(self, text: str, prefix: str = '```', suffix: str = '```', max_size=2000, *, interaction: discord.Interaction, bot: Bot, **kwargs):
        super().__init__(TextPageSource(text, prefix=prefix, suffix=suffix, max_size=max_size), interaction=interaction, bot=bot)
        self.embed = kwargs.get('embed', discord.Embed(colour=bot.colour))